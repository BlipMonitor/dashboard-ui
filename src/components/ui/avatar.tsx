...
type AvatarProps = {
  ...
  alt?: string
  className?: string
  outlined?: boolean // Add this new prop
}
...
export function Avatar({
  ...
  alt = '',
  className,
  outlined = true, // Add default value here
  ...props
  ...
  return (
    <span
      ...
      className={clsx(
        ...
        // Conditionally apply the outline style
        outlined && 'outline outline-1 -outline-offset-1 outline-black/[--ring-opacity] dark:outline-white/[--ring-opacity]',
